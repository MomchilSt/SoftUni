...
namespace TheTankGame.Entities.Vehicles.Factories
{
    ...
    {
        public IVehicle CreateVehicle(string vehicleType, string model, double weight, decimal price, 
            int attack, int defense, int hitPoints)
        {
            ...
            var vehicle = (IVehicle)Activator.CreateInstance(type, model, weight, price, attack, defense, hitPoints, 
