    ...
    class Sneaking
    {
...

        {
            ...
            for (int i = 0; i < moves.Length; i++)
            {
                ...
                MovePlayer(moves, samPosition, i);
                ...
                IsNikoladzeDead(samPosition, getEnemy);
            }
        }

        private static void FindSamsPosition(int[] samPosition)
        {
        ...
        private static void IsNikoladzeDead(int[] samPosition, int[] getEnemy)
        {
        ...
        private static void IsSamAlive(int[] samPosition)
        {
        ...
        private static void MovePlayer(char[] moves, int[] samPosition, int i)
        {
